...
Pointing `oc new-app` at source code kicks off a chain of events, for our example run:
        ...
        $ oc new-app hhttps://github.com/robotshatemonkeys/glsordersv2 -l name=myapp
...
We can also [create new apps using OpenShift template files](https://docs.openshift.com/enterprise/3.0/dev_guide/new_app.html#specifying-a-template). Clone the demo app source code from [GitHub repo](hhttps://github.com/robotshatemonkeys/glsordersv2) (fork if you like).

        $ git clone hhttps://github.com/robotshatemonkeys/glsordersv2
...
Which should return something like:
        ...
        svc/nodejs-ex - 172.30.108.183:8080
          dc/nodejs-ex deploys istag/nodejs-ex:latest <-
            bc/nodejs-ex builds hhttps://github.com/robotshatemonkeys/glsordersv2 with openshift/nodejs:0.10
